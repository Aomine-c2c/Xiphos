  ...
  return (
    <div className="bg-xiphos-panel/60 backdrop-blur-xl border border-xiphos-blue/20 shadow-[0_0_15px_rgba(0,168,255,0.05)] rounded-sm p-4 font-mono select-none flex flex-col justify-between h-full transition-all duration-300 hover:border-xiphos-blue/40">
      ...
      <div className="grid grid-cols-6 gap-4">
        ...
        {/* Card 1: Equity */}
        <div className="bg-xiphos-bg/60 border border-slate-900/60 p-3.5 rounded-sm flex flex-col justify-between h-[105px] relative overflow-hidden group hover:border-xiphos-green/50 transition-colors">
        ...
        {/* Card 3: Net Profit */}
        <div className="bg-xiphos-bg/60 border border-slate-900/60 p-3.5 rounded-sm flex flex-col justify-between h-[105px]">
        ...
        <div className="bg-xiphos-bg/60 border border-slate-900/60 p-3.5 rounded-sm flex flex-col justify-between h-[105px] items-center text-center">
      ...
      <div className="bg-xiphos-bg/80 border border-slate-900 rounded-sm p-3 mt-4 flex items-center justify-between text-[16px] text-[#8e9aa8] font-black tracking-wide leading-none">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex gap-2 items-center">
            ...
            <span className="text-xiphos-blue bg-xiphos-blue/10 px-1.5 py-0.5 rounded-[1px] border border-xiphos-blue/20">
              {capitalAtRisk}
            </span>
          </div>
          <div className="flex gap-2 items-center">
            <span className="uppercase text-[#6f7e90]">PORTFOLIO HEALTH:</span>
            <span className="text-xiphos-green bg-xiphos-green/10 px-1.5 py-0.5 rounded-[1px] border border-xiphos-green/20">
              {portfolioHealth}
            </span>
          </div>
